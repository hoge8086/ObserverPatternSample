================================================================================
    MFC (MICROSOFT FOUNDATION CLASS) ライブラリ : ObserverPatternSample プロジェクトの概要
===============================================================================

この ObserverPatternSample アプリケーションは、アプリケーション ウィザードによって作成されました。このアプリケーションは MFC の基本的な使い方を示すだけでなく、アプリケーションを作成するための開始点でもあります。

このファイルには、ObserverPatternSample アプリケーションを構成する各ファイルの内容の概要が含まれています。

ObserverPatternSample.vcxproj
...
ObserverPatternSample.vcxproj.filters
...
ObserverPatternSample.h
    これはアプリケーションのメイン ヘッダー ファイルです。
    その他のプロジェクト固有のヘッダー (Resource.h など) が含まれ、CObserverPatternSampleApp アプリケーション クラスを宣言します。

ObserverPatternSample.cpp
    これはメインのアプリケーション ソース ファイルで、CObserverPatternSampleApp アプリケーション クラスが含まれています。

ObserverPatternSample.rc
...
res\ObserverPatternSample.ico
    これはアプリケーションのアイコンとして使用されるアイコン ファイルです。このアイコンは、メイン リソース ファイル ObserverPatternSample.rc にインクルードされます。

res\ObserverPatternSample.rc2
...
FigureSettingDlg.h, FigureSettingDlg.cpp - ダイアログ
    これらのファイルには、FigureSettingDlg クラスが含まれます。このクラスはアプリケーションのメイン ダイアログの動作を定義します。ダイアログのテンプレートは、Microsoft Visual C++ で編集できる ObserverPatternSample.rc に含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、ObserverPatternSample.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。

Resource.h
    これは、新しいリソース ID を定義する標準のヘッダー ファイルです。このファイルの読み込みおよび更新は、Microsoft Visual C++ で行います。

ObserverPatternSample.manifest
